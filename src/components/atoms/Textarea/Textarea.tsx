  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className={mergeClassNames(
          className,
          isFullWidth ? "w-full" : "w-[340px]",
          "bg-off-white-500 placeholder:text-lake-lime-300 text-body-s font-heading font-medium rounded-3xl full rounded-br-none px-6 py-3 min-h-40",
